...
abstract class BCodeBodyBuilder extends BCodeSkelBuilder {
  ...
  abstract class PlainBodyBuilder(cunit:   CompilationUnit,
    ...
    def genThrow(expr: Tree): BType = {
      ...
      assert(isNullType(thrownKind) || isNothingType(thrownKind) || exemplars.get(thrownKind).isSubtypeOf(ThrowableReference))
     ...
     *            operations
     */
    def getPrimitive(fun: Symbol, tpe: dotc.core.Types.Type): Int = {
